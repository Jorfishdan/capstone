  ...
  return (
    <>
      <section className="animalnoisecircle">
        ...
        <div className="animalnoisecircle__circle5"></div>
        <div className="animalnoisecircle__circle6"></div>
        <div className="animalnoisecircle__circle7"></div>
        <div className="animalnoisecircle__circle8"></div>
