  ...
  return (
    <>
      <section className="animalnoises__wrapper">
        <div className="animalnoises__circle1"></div>
        <div className="animalnoises__circle2"></div>
        <div className="animalnoises__circle3"></div>
        <div className="animalnoises__circle4"></div>
