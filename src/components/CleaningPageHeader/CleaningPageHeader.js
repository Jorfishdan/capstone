    ...
    <>
      <div className="cleaningPageHeader__header">
        <Link to="/">
          <img
            src={house}
            alt="home icon to press to return to the home page"
            className="cleaningPageHeader__home"
          />
        </Link>
        <Link to="/">
        ...
        <div className="cleaningPageHeader__icon-wrapper">
          <Link to="/brainteaser">
            <img
              src={vet}
              alt="home icon to press to return to the home page"
              className="cleaningPageHeader__brainteaser-link"
            />
          </Link>
          <Link to="/callbacks">
            <img
              src={paw}
              alt="home icon to press to return to the home page"
              className="cleaningPageHeader__callbacks-link"
            />
          </Link>
          <Link to="/mainInfo">
            <img
