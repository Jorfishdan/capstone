...
function InfoCard() {
  ...
  return (
    ...
    <div className="infocard__wrapper">
      <Link to="brainTeaser"><div className="infocard__card--1">Head Scratchers
      <p className="infocard__card--1-info">
        ...
        <Link to="cleanup"> <div className="infocard__card--2">Lightning Clean
     <p className="infocard__card--2-info">
      ...
      <Link to="callbacks"><div className="infocard__card--3">Sneaky Animals
      ...
      <img src={dog4} alt="barking dog cartoon gif" className="infocard__dog" />
    </div>
    </section>
  );
}
