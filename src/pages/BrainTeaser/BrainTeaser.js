          ...
          <div className="brainteaser__icon-wrapper">
            <Link to="/cleanup">
              <img
                src={dogfood}
                alt="home icon to return to main menu"
                className="brainteaser__cleanup-link"
              />
            </Link>
            <Link to="/callbacks">
              <img
